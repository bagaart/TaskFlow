...
class User(db.Model, UserMixin):
    ...
    projects = db.relationship('Project', secondary='project_user', back_populates='users', lazy=True)
...
class Project(db.Model):
    ...
    users = db.relationship('User', secondary='project_user', back_populates='projects', lazy=True)
